    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
            ...
            if(mGattCharacteristic1 != null){
                ...
                Log.d(TAG, "Reading GATT Characteristic");
            }else {
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)){
                ...
                Log.d(TAG, "Broadcast Receiver 3: DEVICE NAME: " + device.getAddress());
                if(device.getName()!= null && device.getAddress().equals("40:BD:32:94:AD:28")){
                    ...
                    Log.d(TAG, "Broadcast Receiver 3: onItemClick: deviceName = " + device.getName());
                    Log.d(TAG, "Broadcast Receiver 3: onItemClick: deviceAddress = " + device.getAddress());


                    mDeviceName = device.getName();
                    mDeviceAddress = device.getAddress();

                    Log.d(TAG, "Broadcast Receiver 3: Pairing Now");
